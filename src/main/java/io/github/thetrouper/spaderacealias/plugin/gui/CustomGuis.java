package io.github.thetrouper.spaderacealias.plugin.gui;

import io.github.thetrouper.spaderacealias.plugin.ItemPresets;
...
public final class CustomGuis {
    ...
    public static final CustomGui EXAMPLE = CustomGui.create()
            ...
            .define(/* slot number */ 12, /* item display */ ItemPresets.EXAMPLE_ITEM) // Clicking this will have no reaction
